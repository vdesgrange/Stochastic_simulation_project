...
def assignment_1_main():
    ...
    print("=== Pure random ===")
    x_, s2_, min, max = statistical_analysis.confidence_interval_estimate(0.02, 100, 1000, 800, re, im, w, h, pure_random)
    ...
    x_, s2_, min, max = statistical_analysis.confidence_interval_estimate(0.02, 100, 1000, 800, re, im, w, h, halton_sequence)
    print("Sample mean     x_  = ", x_)
    print("Sample variance s2_ = ", s2_)
    print("Confidence interval = [{:5f}, {:5f}]".format(min, max))
